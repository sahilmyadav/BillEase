...
/**
 * Authentication controller for user login and password encoding
 * 
 * @author Sahil
 * @version 2.0.0
 */
...
@Tag(name = "Authentication", description = "Authentication endpoints for login and password management")
